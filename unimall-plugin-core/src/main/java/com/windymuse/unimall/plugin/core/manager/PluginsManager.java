package com.windymuse.unimall.plugin.core.manager;

import com.windymuse.unimall.plugin.core.inter.AbstractPlugin;
...
public class PluginsManager {
    ...
    public void registerPlugin(AbstractPlugin plugin) {
        ...
        for (Class clazz : interfaces) {
            ...
            if (name.startsWith("com.windymuse.unimall.plugin.core.inter"))  {
