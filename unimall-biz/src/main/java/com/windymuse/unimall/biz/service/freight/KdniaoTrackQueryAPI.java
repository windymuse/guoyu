...
import com.windymuse.unimall.data.dto.freight.ShipTraceItemDTO;
import com.windymuse.unimall.data.enums.ShipCodeType;
...
public class KdniaoTrackQueryAPI implements ShipTraceQuery {
    ...
    @Value("${com.windymuse.ship.query.kdn.app-key}")
    private String businessID;

    @Value("${com.windymuse.ship.query.kdn.business-id}")
