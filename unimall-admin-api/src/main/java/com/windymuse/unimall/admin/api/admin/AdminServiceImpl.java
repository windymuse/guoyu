package com.windymuse.unimall.admin.api.admin;
...
import com.windymuse.unimall.core.util.MD5Util;
import com.windymuse.unimall.core.util.SHAUtil;
import com.windymuse.unimall.data.component.CacheComponent;
import com.windymuse.unimall.data.domain.AdminDO;
import com.windymuse.unimall.data.domain.RoleDO;
import com.windymuse.unimall.data.domain.RolePermissionDO;
import com.windymuse.unimall.data.dto.AdminDTO;
import com.windymuse.unimall.data.enums.AdminStatusType;
import com.windymuse.unimall.data.enums.RoleStatusType;
import com.windymuse.unimall.data.mapper.AdminMapper;
import com.windymuse.unimall.data.mapper.RoleMapper;
import com.windymuse.unimall.data.mapper.RolePermissionMapper;
...
public class AdminServiceImpl implements AdminService {
    ...
    @Value("${com.windymuse.admin.notify.uninotify.url}")
    private String uniNotifyUrl;

    @Value("${com.windymuse.admin.notify.uninotify.app-secret}")
    private String uniNotifyAppSecret;

    @Value("${com.windymuse.admin.notify.uninotify.app-id}")
