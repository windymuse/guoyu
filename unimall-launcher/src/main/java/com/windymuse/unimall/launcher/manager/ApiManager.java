package com.windymuse.unimall.launcher.manager;

import com.windymuse.unimall.admin.api.role.RoleServiceImpl;
...
import com.windymuse.unimall.data.dto.PermissionPointDTO;
        ...
        for(String gpKey : gpKeys){
            ...
            for(String methodNameKey : methodNameKeys){
                ...
                if(httpMethod != null){
                    ...
                    if(retType.startsWith("com.windymuse")){
                        //若返回值类型为复杂类型
